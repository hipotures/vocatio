...
def parse_args(argv: Optional[Sequence[str]] = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Caption stage photos with Ollama gemma4:e4b and write one /tmp text file per image.")
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    return run_caption_cli(
        ...
        description="Caption gemma4:e4b",
