...
def parse_args(argv: Optional[Sequence[str]] = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Caption stage photos with BLIP and write one /tmp text file per image.")
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    return run_caption_cli(
        ...
        description="Caption BLIP scenes",
        build_captioner=lambda: build_blip_captioner(args.model_name, args.device, args.max_new_tokens),
    )
